        ...
        <div id="contact" className='md:p-5 mt-7 mb-[10rem] p-2'>
            <div className='md:mx-10  mx-2  bg-teal-900 rounded-[2px] '>
                <div className='grid grid-cols-1 md:grid-cols-2'>
                    ...
                    <div>
                        Image
                        {/* to be updated last updated :(4/8/23)  */}
                    </div>
                </div>
            </div>
        </div>
