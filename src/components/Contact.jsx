                        ...
                        <motion.div
                            ...
                            <div className='flex justify-center mt-[3rem]'>
                                <div className='flex justify-evenly items-center w-72 flex-wrap'>
                                    <motion.a whileHover={{ scale: 1.25 }} whileTap={{ scale: 0.9 }} href="https://www.instagram.com/trushil_03/" target='_blank'>
                                    ...
                                    <motion.a whileHover={{ scale: 1.25 }} whileTap={{ scale: 0.9 }} href="https://www.linkedin.com/in/trushil-dhokiya-3b5422231/" target='_blank'>
                                    ...
                                    <motion.a whileHover={{ scale: 1.25 }} whileTap={{ scale: 0.9 }} href="https://github.com/trushildhokiya" target='_blank'>
                                    ...
                                    <motion.a whileHover={{ scale: 1.25 }} whileTap={{ scale: 0.9 }} href="https://www.reddit.com/user/Reaper_legacy" target='_blank'>
                                    ...
                                    <motion.a whileHover={{ scale: 1.25, fill: "rgb(251 ,191 ,36" }} whileTap={{ scale: 0.9 }} href="https://mail.google.com/mail/?view=cm&fs=1&to=trushil.d@somaiya.edu" target="_blank">
